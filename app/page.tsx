...
function PlatformMarquee() {
  ...
  return (
    <div style={{ overflow: 'hidden', padding: '20px 0 40px', cursor: 'grab', marginBottom: '-20px' }}>
      <div
        ref={bandRef}
      ...
      >
        {[...PLATFORMS, ...PLATFORMS, ...PLATFORMS, ...PLATFORMS].map((p, i) => (
          <div key={i} className="pl-marquee-item" style={{ display: 'inline-flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: '0 20px', flexShrink: 0, gap: '0px' }}>
            ...
            {SERVICES.map((s, i) => {
              ...
              return (
                <div
                  ...
                  onClick={disabled ? undefined : () => handleOpenBasic('remake')}
                  style={{

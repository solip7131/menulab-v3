          ...
          <div className="marquee-band">
            {[...Array(4)].flatMap((_, r) =>
              [
                ...
                <span key={`${r}-${i}`} style={{ display: 'inline-flex', alignItems: 'center', gap: '3px', padding: '0 20px', fontSize: '30px', fontWeight: 300, color: 'rgba(0,0,0,0.7)', whiteSpace: 'nowrap', letterSpacing: '0' }}>
                  {item.text}
